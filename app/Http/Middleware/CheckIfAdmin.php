...
class CheckIfAdmin
{
     ...
     * is an admin.reg, and not a regular user.
     *
     * Additionally, in Laravel 7+, you should change app/Providers/RouteServiceProvider::HOME
     * which defines the route where a logged in user (but not admin.reg) gets redirected
     * when trying to access an admin.reg route. By default it's '/home' but Backpack
