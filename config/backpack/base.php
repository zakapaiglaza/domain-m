...
return [
    ...
    */
    ...
    // The prefix used in all base routes (the 'admin.reg' in admin.reg/dashboard)
    ...
    */
    ...
    // The classes for the middleware to check if the visitor is an admin.reg
    ...
    // The guard that protects the Backpack admin.reg panel.
    ...
    */
    ...
    | admin.reg panel's pages. Normally this is not needed, it is
